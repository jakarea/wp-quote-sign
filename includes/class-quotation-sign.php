...
class Quotation_sign {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Quotation_sign_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      string    $quotation_sign    The string used to uniquely identify this plugin.
	 */
	protected $quotation_sign;
	...
	public function __construct() {
		...
		$this->quotation_sign = 'quotation-sign';
		$this->version = '1.0.0';
	 ...
	 *
	 * - Quotation_sign_Loader. Orchestrates the hooks of the plugin.
	 * - Quotation_sign_i18n. Defines internationalization functionality.
	 * - Quotation_sign_Admin. Defines all hooks for the admin area.
	 * - Quotation_sign_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 *core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-quotation-sign-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-quotation-sign-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-quotation-sign-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-quotation-sign-public.php';

        /**
         * The class responsible for defining all actions for AJAX
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-quotation-sign-ajax.php';
		...
		$this->loader = new Quotation_sign_Loader();
	 ...
	 *
	 * Uses the Quotation_sign_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Quotation_sign_i18n();
	...
	private function define_admin_hooks() {
		...
		// $plugin_admin = new Quotation_sign_Admin( $this->get_Quotation_sign(), $this->get_version() );
		 ...
		 * @tutorial access_plugin_admin_public_methodes_from_inside.php
		 */
		$this->admin = new Quotation_sign_Admin( $this->get_quotation_sign(), $this->get_version(), $this->main );
		 ...
		 * @tutorial access_plugin_and_its_methodes_later_from_outside_of_plugin.php
		 */
		// $this->admin = new Quotation_sign_Admin( $this->get_Quotation_sign(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		// $plugin_public = new Quotation_sign_Public( $this->get_quotation_sign(), $this->get_version() );
		 ...
		 * @tutorial access_plugin_admin_public_methodes_from_inside.php
		 */
		$this->public = new Quotation_sign_Public( $this->get_quotation_sign(), $this->get_version(), $this->main );
		// END ACCESS PLUGIN ADMIN PUBLIC METHODES FROM INSIDE
		 ...
		 * @tutorial access_plugin_and_its_methodes_later_from_outside_of_plugin.php
		 */
    	// $this->public = new Quotation_sign_Public( $this->get_quotation_sign(), $this->get_version() );
	 ...
	 */
	public function get_quotation_sign() {
		return $this->quotation_sign;
	}
	 ...
	 *
	 * @since     1.0.0
	 * @return    Quotation_sign_Loader    Orchestrates the hooks of the plugin.
	 */
