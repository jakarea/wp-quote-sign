 ...
 */
class Quotation_sign_Post_Types {
    ...
    private function register_single_post_type( $fields ) {
        ...
        $labels = array(
            ...
            'new_item'              => sprintf( __( 'New %s', 'quotation-sign' ), $fields['singular'] ),
            'add_new_item'          => sprintf( __( 'Add new %s', 'quotation-sign' ), $fields['singular'] ),
            'edit_item'             => sprintf( __( 'Edit %s', 'quotation-sign' ), $fields['singular'] ),
            'view_item'             => sprintf( __( 'View %s', 'quotation-sign' ), $fields['singular'] ),
            'view_items'            => sprintf( __( 'View %s', 'quotation-sign' ), $fields['plural'] ),
            'search_items'          => sprintf( __( 'Search %s', 'quotation-sign' ), $fields['plural'] ),
            'not_found'             => sprintf( __( 'No %s found', 'quotation-sign' ), strtolower( $fields['plural'] ) ),
            'not_found_in_trash'    => sprintf( __( 'No %s found in trash', 'quotation-sign' ), strtolower( $fields['plural'] ) ),
            'all_items'             => sprintf( __( 'All %s', 'quotation-sign' ), $fields['plural'] ),
            'archives'              => sprintf( __( '%s Archives', 'quotation-sign' ), $fields['singular'] ),
            'attributes'            => sprintf( __( '%s Attributes', 'quotation-sign' ), $fields['singular'] ),
            'insert_into_item'      => sprintf( __( 'Insert into %s', 'quotation-sign' ), strtolower( $fields['singular'] ) ),
            'uploaded_to_this_item' => sprintf( __( 'Uploaded to this %s', 'quotation-sign' ), strtolower( $fields['singular'] ) ),

            /* Labels for hierarchical post types only. */
            'parent_item'           => sprintf( __( 'Parent %s', 'quotation-sign' ), $fields['singular'] ),
            'parent_item_colon'     => sprintf( __( 'Parent %s:', 'quotation-sign' ), $fields['singular'] ),
        ...
        if ( isset( $fields['rewrite'] ) ) {
            ...
            /**
             *  Add $this->Quotation_sign as translatable in the permalink structure,
    ...
    private function register_single_post_type_taxnonomy( $tax_fields ) {
        ...
        $labels = array(
            ...
            'all_items'                  => sprintf( __( 'All %s' , 'quotation-sign' ), $tax_fields['plural'] ),
            'edit_item'                  => sprintf( __( 'Edit %s' , 'quotation-sign' ), $tax_fields['single'] ),
            'view_item'                  => sprintf( __( 'View %s' , 'quotation-sign' ), $tax_fields['single'] ),
            'update_item'                => sprintf( __( 'Update %s' , 'quotation-sign' ), $tax_fields['single'] ),
            'add_new_item'               => sprintf( __( 'Add New %s' , 'quotation-sign' ), $tax_fields['single'] ),
            'new_item_name'              => sprintf( __( 'New %s Name' , 'quotation-sign' ), $tax_fields['single'] ),
            'parent_item'                => sprintf( __( 'Parent %s' , 'quotation-sign' ), $tax_fields['single'] ),
            'parent_item_colon'          => sprintf( __( 'Parent %s:' , 'quotation-sign' ), $tax_fields['single'] ),
            'search_items'               => sprintf( __( 'Search %s' , 'quotation-sign' ), $tax_fields['plural'] ),
            'popular_items'              => sprintf( __( 'Popular %s' , 'quotation-sign' ), $tax_fields['plural'] ),
            'separate_items_with_commas' => sprintf( __( 'Separate %s with commas' , 'quotation-sign' ), $tax_fields['plural'] ),
            'add_or_remove_items'        => sprintf( __( 'Add or remove %s' , 'quotation-sign' ), $tax_fields['plural'] ),
            'choose_from_most_used'      => sprintf( __( 'Choose from the most used %s' , 'quotation-sign' ), $tax_fields['plural'] ),
            'not_found'                  => sprintf( __( 'No %s found' , 'quotation-sign' ), $tax_fields['plural'] ),
        );
