 ...
 */
class Quotation_sign_Activator {
	...
	public static function activate() {
         ...
         * Custom Post Types
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-quotation-sign-database.php';
        $plugin_database = new Quotation_sign_DATABASE();
